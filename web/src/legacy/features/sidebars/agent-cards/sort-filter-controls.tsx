	...
	return (
		<Stack gap="md" mb="md">
			<Group gap="sm" wrap="nowrap">
				<TextInput placeholder="Поиск по имени..." value={nameFilter} onChange={(e) => handleNameFilterChange(e.target.value)} />
			...
			<Group gap="sm">
				<Checkbox checked={favoriteFilter} onChange={(e) => handleFavoriteFilterChange(e.currentTarget.checked)} label="Только избранные" />
				<Divider orientation="vertical" />
				<Group gap="xs">
					<Rating count={5} value={ratingFilter ?? 0} onChange={(v) => handleRatingFilterChange(v ? v : null)} />
