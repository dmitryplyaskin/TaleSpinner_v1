...
Источник требований: спекa `docs/pipelines-and-processing-spec/map.md` (v0.1) и статус‑реализация `docs/pipelines-and-processing-implementation/00-status.md`.
