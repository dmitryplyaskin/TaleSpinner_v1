...
> Контекст: `docs/chat-core-spec.md` описывает целевую архитектуру. Ниже — то, что действительно исполняется сейчас.
...
## Расхождения/нюансы относительно `docs/chat-core-spec.md`
