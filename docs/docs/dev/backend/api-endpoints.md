...
| GET | /api/entity-profiles | `server/src/api/entity-profiles.core.api.ts` | L220 |
| POST | /api/entity-profiles | `server/src/api/entity-profiles.core.api.ts` | L228 |
| DELETE | /api/entity-profiles/:id | `server/src/api/entity-profiles.core.api.ts` | L336 |
| GET | /api/entity-profiles/:id | `server/src/api/entity-profiles.core.api.ts` | L245 |
| PUT | /api/entity-profiles/:id | `server/src/api/entity-profiles.core.api.ts` | L258 |
| GET | /api/entity-profiles/:id/chats | `server/src/api/entity-profiles.core.api.ts` | L356 |
| POST | /api/entity-profiles/:id/chats | `server/src/api/entity-profiles.core.api.ts` | L369 |
| GET | /api/entity-profiles/:id/export | `server/src/api/entity-profiles.core.api.ts` | L301 |
