...
| GET | /api/chats/:id/entries | `server/src/api/chat-entries.api.ts` | L691 |
| POST | /api/chats/:id/entries | `server/src/api/chat-entries.api.ts` | L738 |
| POST | /api/chats/:id/entries/continue | `server/src/api/chat-entries.api.ts` | L929 |
| PUT | /api/chats/:id/prompt-template | `server/src/api/chats.core.api.ts` | L44 |
| GET | /api/chats/:id/world-info/latest-activations | `server/src/api/chat-entries.api.ts` | L1242 |
...
| POST | /api/entries/:id/manual-edit | `server/src/api/chat-entries.api.ts` | L1329 |
| GET | /api/entries/:id/prompt-diagnostics | `server/src/api/chat-entries.api.ts` | L1189 |
| POST | /api/entries/:id/prompt-visibility | `server/src/api/chat-entries.api.ts` | L1500 |
| POST | /api/entries/:id/regenerate | `server/src/api/chat-entries.api.ts` | L1064 |
| POST | /api/entries/:id/soft-delete | `server/src/api/chat-entries.api.ts` | L1486 |
| GET | /api/entries/:id/variants | `server/src/api/chat-entries.api.ts` | L1266 |
| POST | /api/entries/:id/variants/:variantId/select | `server/src/api/chat-entries.api.ts` | L1283 |
| POST | /api/entries/:id/variants/:variantId/soft-delete | `server/src/api/chat-entries.api.ts` | L1433 |
| POST | /api/entries/soft-delete-bulk | `server/src/api/chat-entries.api.ts` | L1473 |
...
| POST | /api/parts/:id/soft-delete | `server/src/api/chat-entries.api.ts` | L1533 |
