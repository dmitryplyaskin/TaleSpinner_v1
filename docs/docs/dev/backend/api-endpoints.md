...
| GET | /api/chats/:id/entries | `server/src/api/chat-entries.api.ts` | L799 |
| POST | /api/chats/:id/entries | `server/src/api/chat-entries.api.ts` | L846 |
| POST | /api/chats/:id/entries/continue | `server/src/api/chat-entries.api.ts` | L1037 |
| PUT | /api/chats/:id/instruction | `server/src/api/chats.core.api.ts` | L44 |
| GET | /api/chats/:id/world-info/latest-activations | `server/src/api/chat-entries.api.ts` | L1363 |
...
| POST | /api/entries/:id/manual-edit | `server/src/api/chat-entries.api.ts` | L1450 |
| GET | /api/entries/:id/prompt-diagnostics | `server/src/api/chat-entries.api.ts` | L1310 |
| POST | /api/entries/:id/prompt-visibility | `server/src/api/chat-entries.api.ts` | L1621 |
| POST | /api/entries/:id/regenerate | `server/src/api/chat-entries.api.ts` | L1172 |
| POST | /api/entries/:id/soft-delete | `server/src/api/chat-entries.api.ts` | L1607 |
| GET | /api/entries/:id/variants | `server/src/api/chat-entries.api.ts` | L1387 |
| POST | /api/entries/:id/variants/:variantId/select | `server/src/api/chat-entries.api.ts` | L1404 |
| POST | /api/entries/:id/variants/:variantId/soft-delete | `server/src/api/chat-entries.api.ts` | L1554 |
| POST | /api/entries/soft-delete-bulk | `server/src/api/chat-entries.api.ts` | L1594 |
...
| POST | /api/parts/:id/soft-delete | `server/src/api/chat-entries.api.ts` | L1654 |
| POST | /api/rag/embeddings | `server/src/api/rag.api.ts` | L113 |
| GET | /api/rag/presets | `server/src/api/rag.api.ts` | L62 |
| POST | /api/rag/presets | `server/src/api/rag.api.ts` | L66 |
| DELETE | /api/rag/presets/:id | `server/src/api/rag.api.ts` | L74 |
| PUT | /api/rag/presets/:id | `server/src/api/rag.api.ts` | L70 |
| POST | /api/rag/presets/:id/apply | `server/src/api/rag.api.ts` | L92 |
| GET | /api/rag/providers | `server/src/api/rag.api.ts` | L34 |
| GET | /api/rag/providers/:providerId/config | `server/src/api/rag.api.ts` | L46 |
| PATCH | /api/rag/providers/:providerId/config | `server/src/api/rag.api.ts` | L51 |
| GET | /api/rag/runtime | `server/src/api/rag.api.ts` | L38 |
| PATCH | /api/rag/runtime | `server/src/api/rag.api.ts` | L42 |
| GET | /api/rag/tokens | `server/src/api/rag.api.ts` | L56 |
| GET | /api/settings/rag-presets | `server/src/api/rag.api.ts` | L84 |
| POST | /api/settings/rag-presets | `server/src/api/rag.api.ts` | L88 |
