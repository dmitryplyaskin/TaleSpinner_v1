...
| POST | /api/rag/embeddings | `server/src/api/rag.api.ts` | L106 |
| GET | /api/rag/presets | `server/src/api/rag.api.ts` | L55 |
| POST | /api/rag/presets | `server/src/api/rag.api.ts` | L59 |
| DELETE | /api/rag/presets/:id | `server/src/api/rag.api.ts` | L67 |
| PUT | /api/rag/presets/:id | `server/src/api/rag.api.ts` | L63 |
| POST | /api/rag/presets/:id/apply | `server/src/api/rag.api.ts` | L85 |
| GET | /api/rag/providers | `server/src/api/rag.api.ts` | L23 |
| GET | /api/rag/providers/:providerId/config | `server/src/api/rag.api.ts` | L39 |
| PATCH | /api/rag/providers/:providerId/config | `server/src/api/rag.api.ts` | L44 |
| GET | /api/rag/runtime | `server/src/api/rag.api.ts` | L27 |
| PATCH | /api/rag/runtime | `server/src/api/rag.api.ts` | L31 |
| GET | /api/rag/tokens | `server/src/api/rag.api.ts` | L49 |
| GET | /api/settings/rag-presets | `server/src/api/rag.api.ts` | L77 |
| POST | /api/settings/rag-presets | `server/src/api/rag.api.ts` | L81 |
