...
import { getChatPipelineDebug } from "../services/chat-core/pipeline-debug";

const router = express.Router();

router.get(
  "/chats/:id/pipeline-debug",
  validate({
  ...
  asyncHandler(async (req: Request) => {
    ...
    const branchId = query.branchId ?? chat.activeBranchId ?? undefined;
    const debug = await getChatPipelineDebug({
