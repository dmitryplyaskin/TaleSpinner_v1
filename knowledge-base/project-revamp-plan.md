...
Этот документ описывает **конкретные шаги** перехода от текущего MVP-устройства к новой архитектуре, описанной в `knowledge-base/chat-core-spec.md`.
...
- **Зафиксировать** спеку как source of truth:
  - `knowledge-base/chat-core-spec.md` — ядро домена и хранения
...
Добавить/обновить таблицы (см. `knowledge-base/chat-core-spec.md`):
