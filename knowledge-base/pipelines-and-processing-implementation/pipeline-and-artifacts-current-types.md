...
Источник требований: `knowledge-base/pipelines-and-processing-spec/map.md`, а актуальные “что сделано”/ссылки — `knowledge-base/pipelines-and-processing-implementation/00-status.md`.
